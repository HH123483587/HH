...
class Bird(object):
    def __init__(self):
        ...
        '''定义鸟的状态图片'''
        self.birdStatus = [pygame.image.load(current_dir+'\\All_image\\birds_fly\\up.png'),
                           pygame.image.load(current_dir+'\\All_image\\birds_fly\\down.png'),
                           pygame.image.load(current_dir+'\\All_image\\birds_fly\\dead.png')]
        '''默认飞行状态'''
        self.status = 0
        '''鸟所在X轴，即向右飞行的速度'''
        self.birdX = 120
...
class Pipeline(object):
    ...
    def __init__(self):
        ...
        self.wallx = 400
        '''加载上管道图片'''
        self.pineUp = pygame.image.load(current_dir+'\\All_image\\birds_fly\\shang_guandao.png')
        '''加载下管道图片'''
        self.pineDown = pygame.image.load(current_dir+'\\All_image\\birds_fly\\xia_guandao.png')
...
def birds_fly():
    ...
    while running:
        ...
        if (event.type == pygame.KEYDOWN or event.type == pygame.MOUSEBUTTONDOWN) and not bird.dead:
             ...
             bird.jumpSpeed = 10
        '''绘制背景'''
        background = pygame.image.load(current_dir+'\\All_image\\birds_fly\\02.jpg')
