...
def give_label_with_picture(master, image) -> Label:
    ...
    resize_image.save(current_dir + "\\All_image\\resized_image.png")
    #
    photo = ImageTk.PhotoImage(file=current_dir + "\\All_image\\resized_image.png")
    lab = Label(master)
