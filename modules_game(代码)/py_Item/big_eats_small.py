    ...
    def eat(self, other):
        if self.alive and other.alive and self != other:
            ...
            if distance < (self.r + other.r) and self.r > other.r:
                other.alive = False
                self.r = self.r + int(other.r * 0.15)
...
def main():
    ...
    def randon_ball(p_r):
        ...
        r = random.randint(p_r - 5, p_r + 2)
        sx, sy = random.randint(-7, 7), random.randint(-7, 7)
        ...
        while start:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if (event.key == pygame.K_UP) or (event.key == pygame.K_KP8) or (event.key == pygame.K_w):
                        p_ball.sy = -5
                        p_ball.sx = 0
                    if (event.key == pygame.K_LEFT) or (event.key == pygame.K_KP4) or (event.key == pygame.K_a):
                        p_ball.sx = -5
                        p_ball.sy = 0
                    if (event.key == pygame.K_RIGHT) or (event.key == pygame.K_KP6) or (event.key == pygame.K_d):
                        p_ball.sx = 5
                        p_ball.sy = 0
                    if (event.key == pygame.K_DOWN) or (event.key == pygame.K_KP2) or (event.key == pygame.K_s):
                        p_ball.sy = 5
                        p_ball.sx = 0
            ...
            if score >= 200:
                ...
                score_surface = my_font.render('You Score Is:' + str(score), True, pygame.Color(255, 0, 0))
