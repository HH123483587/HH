...
class Snake(object):
    ...
    def __init__(self, snake_speed):
        ...
        self.snake_head = pygame.image.load(current_dir+'\image\snake_head.jpg')
...
class Food(object):
    def __init__(self, window, food_color):
        ...
        self.food = pygame.image.load(current_dir+r'\image\food.jpg')
...
def read_score():
    with open(file='score.txt', mode='a', encoding='utf8'):
        with open(file='score.txt', mode='r', encoding='utf8') as f:
...
def main(window_x, window_y, snake_speed, max_speed):
    ...
    def writ_score():
        ...
        with open(file='score.txt', encoding='utf8', mode='a') as f:
